      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" id="month" name="month">
                    ...
                    <?php while ($m = $month->fetch_assoc()) { ?>
                      <option value="<?php echo $m['id'] ?>" <?php if (isset($_GET['month']) && $_GET['month'] == $m['id']) {?>selected="selected"<?php }?>>
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" id="site" name="site">
                    ...
                    <?php while ($s = $sites->fetch_assoc()) { ?>
                      <option value="<?php echo $s['id'] ?>" <?php if (isset($_GET['site']) && $_GET['site'] == $s['id']) {?>selected="selected"<?php }?>>
            ...
            <?php
            if (isset($_GET['month']) && isset($_GET['site'])) {
              $month = $_GET['month'];
              $site = $_GET['site'];
