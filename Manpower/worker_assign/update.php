...
if (isset($_POST['siteID'])) {
    ...
    $conn->query("UPDATE `worker_assign` SET `siteID` = '$siteID', `customer_id` = '$customerId', `workerID` = '$workerID', `per_day_salary` = '$per_day_salary', `ot_rate` = '$ot_rate', `type` = '$type', `monthID` = '$monthID', `status` = '$status' WHERE `worker_assign`.`id` = $id;"); 
                ...
                <tr>
                 ...
                 while ($emp_data = $emp_table->fetch_assoc()) { ?>
                      <option 
                        ...
                        <?php if ($emp_data['id']==$update['customer_id']) {
                     echo " selected ";
                    }  ?>
                        >
