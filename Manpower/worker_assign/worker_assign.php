...
if (isset($_POST['siteID'])) {
    ...
    $yy=$conn->query("INSERT INTO `worker_assign` (`id`, `siteID`, `workerID`, `per_day_salary`, `ot_rate`, `type`, `monthID`, `status`, customer_id) VALUES (NULL, '$siteID', '$workerID', '$per_day_salary', '$ot_rate', '$type', '$monthID', '$customerId', '$status')"); ?>
          ...
          <div class="card-body">
            <form action="" method="post">
              <?php if ($_SESSION['type'] == 'customer') { ?>
                <input type="hidden" name="customer_id" id='customer_id' value="<?php echo $_SESSION['id']?>" />
              <?php } ?>
              <table class="table table-bordered table-striped table-hover ">
                ...
                <tr>
                  ...
                  <select class="form-control" name="customer_id">
                      ...
                      <?php
                 $emp_table = $conn->query("SELECT * FROM `customers` ");
